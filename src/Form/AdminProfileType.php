    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ->add('name', TextType::class, [
                'label' => 'Nom complet',
                'attr' => ['placeholder' => 'Admin Teako'],
            ])
            ->add('email', EmailType::class, [
                'label' => 'Adresse e-mail',
                'attr' => ['placeholder' => 'admin@teako.mg'],
            ])
            ...
            ->add('newPassword', RepeatedType::class, [
                ...
                'constraints' => [
                    new Length(min: 6, minMessage: 'Le mot de passe doit comporter au moins {{ limit }} caractères.', max: 72),
                ],
